...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 22 17:18:34 2019
Auxiliary functions to analyze mass spectrums
...
#%% Functions to analyz temporal signals

def fun_plot_mass(masa,sp):
    my_dpi = 72
    plt.figure(678,figsize=(800/my_dpi, 600/my_dpi), dpi=my_dpi)
    plt.subplot(221)
    plt.plot(masa, sp)
    plt.xlim(10,20)
    plt.grid(linestyle='--')
